...
def test_sarsa():
    ...
    agent.save(r'D:\projet_DRL\tests\Monty_hall_Lvl_1\policy\sarsa_policy_MH1.npz')
    print("Politique et fonctions sauvegardées dans 'sarsa_policy_MH1.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL\tests\Monty_hall_Lvl_1\policy\sarsa_policy_MH1.npz')
