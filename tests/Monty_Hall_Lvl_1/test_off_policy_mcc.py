...
def test_off_policy_mcc():
    ...
    agent.save(r'D:\projet_DRL\tests\Monty_hall_Lvl_1\policy\off_policy_mcc_MH1.npz')
    print("Politique et fonctions sauvegardées dans 'off_policy_mcc_MH1.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL\tests\Monty_hall_Lvl_1\policy\off_policy_mcc_MH1.npz')
