...
def test_value_iteration():
    ...
    agent.save(r'D:\projet_DRL\tests\Monty_hall_Lvl_1\policy\value_iteration_policy_MH1.npz')
    ...
    agent.load(r'D:\projet_DRL\tests\Monty_hall_Lvl_1\policy\value_iteration_policy_MH1.npz')
