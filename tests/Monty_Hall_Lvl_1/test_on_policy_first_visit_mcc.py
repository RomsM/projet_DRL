...
def test_On_first_visit_mcc():
    ...
    agent.save(r'D:\projet_DRL\tests\Monty_hall_Lvl_1\policy\on_policy_first_visit_MH1.npz')
    print("Politique et fonctions sauvegardées dans 'on_policy_first_visit_MH1.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL\tests\Monty_hall_Lvl_1\policy\on_policy_first_visit_MH1.npz')
