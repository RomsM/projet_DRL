...
def test_value_iteration():
    ...
    agent.save(r'D:\projet_DRL\tests\line_world\policy\value_iteration_policy.npz')
    ...
    agent.load(r'D:\projet_DRL\tests\line_world\policy\value_iteration_policy.npz')
