...
def test_policy_iteration():
    ...
    agent.save(r'D:\projet_DRL\tests\Monty_hall_Lvl_2\policy\policy_iteration_MH2.npz')
    print("Politique et fonctions sauvegardées dans 'policy_iteration_MH2.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL\tests\Monty_hall_Lvl_2\policy\policy_iteration_MH2.npz')
