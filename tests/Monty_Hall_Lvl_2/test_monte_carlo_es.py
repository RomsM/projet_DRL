...
def test_monte_carlo_es():
    ...
    agent.save(r'D:\projet_DRL\tests\Monty_hall_Lvl_2\policy\monte_carlo_es_policy_MH2.npz')
    print("Politique et fonctions sauvegardées dans 'monte_carlo_es_policy_MH2.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL\tests\Monty_hall_Lvl_2\policy\monte_carlo_es_policy_MH2.npz')
