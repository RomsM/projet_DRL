...
def test_dyna_q():
    ...
    agent.train(num_episodes=100000)  # Augmenté pour une meilleure convergence
    ...
    agent.save(r'D:\projet_DRL\tests\Monty_hall_Lvl_2\policy\dyna_q_policy_MH2.npz')
    print("Politique et fonctions sauvegardées dans 'dyna_q_policy_MH2.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL\tests\Monty_hall_Lvl_2\policy\dyna_q_policy_MH2.npz')
