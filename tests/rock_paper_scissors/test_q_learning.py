...
def test_q_learning():
    ...
    agent.save('tests/rock_paper_scissors/policy/q_learning_policy_rps.npz')
    logging.info("Politique et fonctions sauvegardées dans 'q_learning_policy_rps.npz'.")

    # Chargement de la politique et des fonctions
    agent.load('tests/rock_paper_scissors/policy/q_learning_policy_rps.npz')
